<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
    <section class="sidebar">
            ...
            <div class="user-panel p-3 light mb-2">
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        <a href="<?=base_url();?>Seller_admin/restaurant_view" class="list-group-item list-group-item-action ">
                            <i class="mr-2 icon-umbrella text-blue"></i>Profile
                        </a>
                        <a href="#" class="list-group-item list-group-item-action"><i
                                class="mr-2 icon-cogs text-yellow"></i>Settings</a>
                        <a href="<?=base_url();?>Seller_admin/change_password" class="list-group-item list-group-item-action"><i
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
            	<a href="<?=base_url();?>Seller_admin/dashboard">
            ...
            <li class="treeview"><a href="#"><i class="icon icon-account_box light-green-text s-18"></i>Users<i
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?=base_url();?>Seller_admin/profile"><i class="icon icon-user"></i>User Profile </a>
                    </li>
                </ul>
            </li>

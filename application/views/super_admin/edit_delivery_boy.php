                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body b-b">
                            ...
                            <h4>Personal Info</h4>
                            <form class="form-material" action="<?= base_url(); ?>Super_admin/updateDeliveryBoy/<?php echo $deliveryBoyData[0]['dboy_id'];?>" method="post"
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="dboy_name"
                                                           value="<?= set_value('dboy_name',$deliveryBoyData[0]['dboy_name']); ?>">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="dboy_mobile"
                                                           value="<?= set_value("dboy_mobile",$deliveryBoyData[0]['dboy_mobile']); ?>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea class="form-control" name="dboy_address"
                                                          value="<?= set_value('dboy_address',$deliveryBoyData[0]['dboy_address']); ?>">
                                                    <?= set_value('dboy_address',$deliveryBoyData[0]['dboy_address']); ?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="Email" class="form-control" name="dboy_email"
                                                       value="<?= set_value('dboy_email',$deliveryBoyData[0]['dboy_email']); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>

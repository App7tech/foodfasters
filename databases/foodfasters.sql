...
INSERT INTO `cart` (`cart_id`, `restaurant_id`, `product_id`, `customer_id`, `quantity`, `date_time`) VALUES
(1, 1, 2, 1, 2, '0000-00-00 00:00:00'),
(2, 1, 2, 11, 1, '0000-00-00 00:00:00'),
(3, 1, 3, 1, 2, '0000-00-00 00:00:00'),
(4, 1, 4, 1, 2, '0000-00-00 00:00:00'),
(5, 1, 4, 2, 2, '0000-00-00 00:00:00'),
(6, 1, 4, 3, 4, '0000-00-00 00:00:00'),
(7, 1, 12, 1, 2, '0000-00-00 00:00:00'),
(8, 1, 12, 1122312, 2, '0000-00-00 00:00:00'),
(9, 1, 12, 41, 2, '0000-00-00 00:00:00');
...
(3, 'testProd', 'tasty yummy dish', 200, 200, '1c08d7329907f56691b6edd8ca6d1282.gif', 3, 3, 0, 0, 3, 1, '2018-10-14 06:47:30'),
...
(6, 'prod1', 'abc def chg lorem ipsum', 200, 150, 'd611fd637f749805beb3910a730735f0.jpg', 1, 7, 0, 0, 1, 1, '2018-10-14 06:39:06'),
(7, 'Spicy chicken', 'kjfgnkjsfg kjnsfkjgnkf', 21, 231, 'f338d508007da130ed690c404b7a8d85.jpg', 2, 7, 0, 0, 1, 1, '2018-10-14 06:45:09'),
...
INSERT INTO `restaurant_add` (`restaurant_id`, `name`, `mobile`, `restaurant_name`, `restaurant_email`, `password`, `token`, `image`, `restaurant_address`, `restaurant_city`, `restaurant_state`, `Latitude`, `longitude`, `open_days`, `open_time`, `close_time`, `status`, `datetime`) VALUES
